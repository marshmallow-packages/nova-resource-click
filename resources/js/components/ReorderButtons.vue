  ...
  computed: {
    ...
    reorderDisabledTooltip() {
      return this.reorderDisabled
        ? this.__(`NovaResourceClick.reorderingDisabledTooltip.${this.reorderDisabled}`)
        : void 0;
    },
     ...
     */
    moveToStartTooltip() {
      return !this.reorderDisabled ? this.__('NovaResourceClick.moveToStart') : void 0;
    },
     ...
     */
    moveToEndTooltip() {
      return !this.reorderDisabled ? this.__('NovaResourceClick.moveToEnd') : void 0;
    },
  },
};
</script>
