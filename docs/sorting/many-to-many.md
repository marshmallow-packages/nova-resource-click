...
```php
use Marshmallow\NovaResourceClick\Traits\HasSortableManyToManyRows;
...
See this issue for guidance: [nova-sortable/issues#60](https://github.com/marshmallow/nova-sortable/issues/60).
